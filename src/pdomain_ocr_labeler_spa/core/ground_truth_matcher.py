...
A thin wrapper over ``pdomain_book_tools.ocr.ground_truth_matching`` (reached
...
never wrapped in :class:`pdomain_book_tools.ocr.page.Page`).  Never raises
...
def rematch_page(page: Any, gt_text: str) -> bool:
    ...
    ----------
    page :
        A ``pdomain_book_tools.ocr.page.Page``-shaped object exposing
